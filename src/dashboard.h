...
.btn.reboot-style{background:#332222;color:#ff3333;border-color:#ff3333;width:100%;margin-top:10px;font-family:monospace;font-weight:bold;padding:6px 10px;cursor:pointer;border-radius:4px;font-size:11px;}
